# App del estado del tiempo en ciudades usando Java y la libreria [Volley](https://github.com/google/volley) para la conexion de la [API] (https://www.metaweather.com/api/)
